...
if (element !== null) {
    element.innerHTML = "";
    var nilai  = element.getAttribute('nilai');
    var options = {
        chart: {
            height: 127,
            width: 100,
...
export function crmtotalCustomers(myVarVal) {
...
export function revenueAnalytics(myVarVal) {
    chart.updateOptions({
...
export function crmProfitsearned(myVarVal) {
