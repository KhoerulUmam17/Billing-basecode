                ...
                <div @class([ 'grid sm:grid-cols-1'=> $this->formColumn === 1,
                    ...
                    <div class="w-full mb-6">
                        ...
                        <input maxlength="15"
                            ...
                            class="@error('phone') is-invalid @enderror border-sky-100 form-control"
                            placeholder="Mobile Phone" required>
                        <div class="check-phone">
                            <input wire:model.live='samePhone' wire:click='fillClick' type="checkbox" value=""
                                class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                            <label for="default-checkbox" class="ms-2 text-xs font-normal text-gray-900 dark:text-gray-300">
                                Same whatsapp number ? (indonesian format)
                            </label>
                        </div>
                        @error('phone')
                            <span class="text-danger">{{ $message }}</span>
    ...
    @section('scripts')
        ...
        <script>
            ...
            Livewire.on('dataSaved', function() {
                $('#job_title').val(null).trigger('change'); // Mengatur ulang Select2
                $('#status').val(null).trigger('change'); // Mengatur ulang Select2
                $('#assigned_to').val(null).trigger('change'); // Mengatur ulang Select2
            });
        </script>
        ...
        <script>
            ...
            step = [
                {popover: { title: "{{__('guide.contacts.stepadd.1.title')}}", description: "{{__('guide.contacts.stepadd.1.description')}}", side: "buttom", align: 'start' }},
                {element: '.field-name', popover: { title: "{{__('guide.contacts.stepadd.2.title')}}", description: "{{__('guide.contacts.stepadd.2.description')}}", side: "right", align: 'center' }},
                {element: '.red-star', popover: { title: "{{__('guide.contacts.stepadd.3.title')}}", description: "{{__('guide.contacts.stepadd.3.description')}}", side: "right", align: 'center' }},
                {element: '.check-phone', popover: { title: "{{__('guide.contacts.stepadd.4.title')}}", description: "{{__('guide.contacts.stepadd.4.description')}}", side: "top", align: 'center' }},
                {element: '.select-example', popover: { title: "{{__('guide.contacts.stepadd.5.title')}}", description: "{{__('guide.contacts.stepadd.5.description')}}", side: "top", align: 'center' }},
                {popover: { title: "{{__('guide.contacts.stepadd.6.title')}}", description: "{{__('guide.contacts.stepadd.6.description')}}", side: "buttom", align: 'start' }},
            ];
            ...
            if (!localStorage.getItem("guideShownAddContacts")) {
                driverObj.drive();
                localStorage.setItem("guideShownAddContacts", "true"); // Tandai guide sebagai ditampilkan
            }
        </script>
