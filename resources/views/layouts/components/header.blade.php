            ...
            <div class="header-content-right">
                ...
                <div
                    ...
                    <button id="dropdown-flag" type="button"
                        ...
                        @if (Session::get('locale') == 'id')
                            <img src="{{asset('build/assets/images/flags/id_flag.jpg')}}" alt="flag-img"
                    ...
                    <div class="hs-dropdown-menu ti-dropdown-menu min-w-[10rem] hidden !-mt-3"
                        ...
                        <div class="ti-dropdown-divider divide-y divide-gray-200 dark:divide-white/10">
                            <div class="py-2 first:pt-0 last:pb-0">
                                ...
                                <div class="ti-dropdown-item !p-[0.65rem]">
                                    <a href="{{url('/set-locale?lang=id')}}">
                                        <div class="flex items-center space-x-2 rtl:space-x-reverse w-full">
                                            <div class="h-[1.375rem] w-[1.375rem] flex items-center rounded-full">
                                                <img src="{{asset('build/assets/images/flags/id_flag.jpg')}}"
                                    ...
                                    <div class="grow flex items-center justify-between">
                                        <div>
                                            <p
                                                ...
                                                <a href="{{url('notifications')}}">Your Order Has Been Shipped</a></p>
                                            <span
                                ...
                                <div class="flex items-start">
                                    ...
                                    <div class="grow flex items-center justify-between">
                                        <div>
                                            <p
                                                class="mb-0 text-defaulttextcolor dark:text-[#8c9097] dark:text-white/50 text-[0.8125rem]  font-semibold">
                                                <a href="{{url('notifications')}}">Discount Available</a></p>
                                            <span
                                ...
                                <div class="flex items-start">
                                    ...
                                    <div class="grow flex items-center justify-between">
                                        <div>
                                            <p
                                                class="mb-0 text-defaulttextcolor dark:text-[#8c9097] dark:text-white/50 text-[0.8125rem]  font-semibold">
                                                <a href="{{url('notifications')}}">Account Has Been Verified</a></p>
                                            <span
                                ...
                                <div class="flex items-start">
                                    ...
                                    <div class="grow flex items-center justify-between">
                                        <div>
                                            <p
                                                class="mb-0 text-defaulttextcolor dark:text-[#8c9097] dark:text-white/50  text-[0.8125rem]  font-semibold">
                                                <a href="{{url('notifications')}}">Order Placed <span
                                ...
                                <div class="flex items-start">
                                    ...
                                    <div class="grow flex items-center justify-between">
                                        <div>
                                            <p
                                                class="mb-0 text-defaulttextcolor dark:text-[#8c9097] dark:text-white/50  text-[0.8125rem]  font-semibold">
                                                <a href="{{url('notifications')}}">Order Delayed <span
                ...
                <div
                    ...
                    <button id="dropdown-profile" type="button"
                        ...
                        <img id="profileImage" class="inline-block rounded-full"
                            src="{{ Storage::url(auth()->user()->photo) }}" width="32" height="32"
                            alt="Image Description">
                        @else
                        <img id="profileImage" class="inline-block rounded-full "
                            src="{{asset('build/assets/images/faces/9.jpg')}}" width="32" height="32"
                            alt="Image Description">
                        @endif
                    ...
                    <div class="md:block hidden dropdown-profile">
                        <p class="font-semibold mb-0 leading-none text-[#536485] text-[0.813rem] ">
                            {{auth()->user()->name}}</p>
                        <span
                            class="opacity-[0.7] font-normal text-[#536485] block text-[0.6875rem] ">{{auth()->user()->getRolesNames[0]
                            ?? '-'}}</span>
                    </div>
                ...
                @if (auth()->user()->roles && auth()->user()->roles->contains('name', 'superadmin'))
                <!-- Switcher Icon -->
