            ...
            <aside class="app-sidebar sticky !topacity-0" id="sidebar">
                <div class="container-xl xl:!p-0">
                    ...
                    <nav class="main-menu-container nav nav-pills flex-column sub-open">
                        ...
                        <div class="responsive-logo w-32">
                            ...
                            <a class="responsive-logo-dark" href="{{url('index')}}" aria-label="Brand"><img
                                src="{{asset('build/assets/images/brand-logos/desktop-dark.png')}}" alt="logo" class="mx-auto"></a>
                        </div>
                        </div>
                        ...
                        <a href="{{route('login')}}" class="ti-btn w-[6.375rem] ti-btn-primary-full m-0 p-2">
                            Log In</a>
