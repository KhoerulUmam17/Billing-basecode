                ...
                <div class="w-full lg:w-8/12 px-4 ml-auto mr-auto text-center">
                    <div class="lg:pr-12">
                        ...
                        <p class="mt-4 text-lg text-slate-200">
                            Sistem Monitoring Akademik Siswa SMPIT AL-ANWAR Sebuah sistem atau media untuk melihat perkembangan siswa dalam sekolah dengan mudah.
                        </p>
                    </div>
                </div>
            </div>
    ...
    <section class="pb-20 bg-slate-200 -mt-24">
        <div class="container mx-auto px-4">
            <div class="flex flex-wrap">
                <div class="lg:pt-12 pt-6 w-full md:w-4/12 px-4 text-center transform transition duration-500 hover:scale-110">
                    <a href="{{route('register-guru')}}">
                        ...
                        <div class="px-4 py-5 flex-auto">
                            ...
                            <h6 class="text-xl font-semibold">Akun Guru</h6>
                ...
                <div class="w-full md:w-4/12 px-4 text-center transform transition duration-500 hover:scale-110">
                    <a href="{{route('add-kode-siswa')}}">
                        <div
                            class="relative flex flex-col min-w-0 break-words bg-white w-full mb-8 shadow-lg rounded-lg">
                            <div class="px-4 py-5 flex-auto">
                                <div
                                ...
                                <h6 class="text-xl font-semibold">Akun Siswa</h6>
                                <p class="mt-2 mb-4 text-slate-500">
                ...
                <div class="pt-6 w-full md:w-4/12 px-4 text-center transform transition duration-500 hover:scale-110">
                    <a href="{{route('register-ortu')}}">
                        <div
                            class="relative flex flex-col min-w-0 break-words bg-white w-full mb-8 shadow-lg rounded-lg">
                            <div class="px-4 py-5 flex-auto">
                                <div
                                ...
                                <h6 class="text-xl font-semibold">Akun Orang Tua</h6>
                                <p class="mt-2 mb-4 text-slate-500">
