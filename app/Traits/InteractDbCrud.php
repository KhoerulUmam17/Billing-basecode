...
trait InteractDbCrud
{
    ...
    {
        $data = $this->data->orderBy('id', 'desc')->paginate(15);
    ...
    public function update()
    {
        ...
        try {
            $this->data->find($this->key)->update($payload);
    ...
    {
        try {
            $this->data->find($this->key)->delete();
